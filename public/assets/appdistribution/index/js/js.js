...
Modal.determineModal({
    ...
    title: '提示',
    p: '该链接为测试连接，只能下载<span class="color-danger">5</span>次。<br>建议您：<br>1、电脑登录管理后台，<br>2、点击导航栏【发布】，<br>3、将APP上传至网站，即可获得正式下载地址。',
    align: 'left',
    btnText: '已知晓'
});
*/
...
Modal.templateModal({
    ...
    title1: '提示',
    title2: '',
    p: '建议您：<br>尽快<span class="color-danger">电脑</span>登录管理后台，即可享受<br><span class="iconfont icon-xingxing" style="color: #fec323; font-size: 12px; margin-right: 5px;"></span>免费试用封装打包APP<br><span class="iconfont icon-xingxing" style="color: #fec323; font-size: 12px; margin-right: 5px;"></span>每天免费赠送<span class="color-danger">1000</span>次分发下载次数',
...
$(function () {
    ...
    setRem();
    $('.sidebar-fixed .left-troggle').on('click',function () {
        if($(this).hasClass('actived')){
            $(this).removeClass('actived')
            $('.left-collapse-box.sidebar-fixed').css('left', '-200px');
        }else{
            $(this).addClass('actived')
            $('.left-collapse-box.sidebar-fixed').css('left', '0');
        }
    })
