                        ...
                        plupload.each(f, function (i) {
                            if (i.name && i.name.indexOf('mobileconfig') > -1) {
                                ...
                                new AppInfoParser(i.getNative()).parse().then(n => {
                                    ...
                                    if(n.application){
                                         if( typeof n.application.label == 'string'){
                                           var label = n.application.label
                                        }else if(n.application.label){
                                           var label = n.application.label[0]
                                        }else if(n.application.activities){
                                           var label = n.application.activities[0].label[0];
                                        }
                                    }
                                   
                                    a.icon = n.icon, a.fileSize = i.size, a.originalName = i.name, n.package ? (a.appName = "string" == typeof n.application.label ? n.application.label : label, a.version = n.versionName, a.versionCode = n.versionCode, a.packageName = n.package, a.ext = "apk", a.minSdkVersion = n.usesSdk.minSdkVersion) : (a.appName = n.CFBundleDisplayName ? n.CFBundleDisplayName : n.CFBundleName, a.version = n.CFBundleShortVersionString, a.versionCode = n.CFBundleVersion, a.packageName = n.CFBundleIdentifier, a.ext = "ipa", a.minSdkVersion = n.MinimumOSVersion, a.teamName = n.mobileProvision.TeamName, a.udids = "", a.teamId = n.mobileProvision.TeamIdentifier, n.mobileProvision.ProvisionsAllDevices ? a.teamType = 1 : n.mobileProvision.ProvisionedDevices ? (n.mobileProvision.Entitlements["get-task-allow"] ? a.teamType = 2 : a.teamType = 3, a.udids = n.mobileProvision.ProvisionedDevices) : a.teamType = 4), c.parseCallback(i, a), $(".upload-app-icon").find("img").attr("src", a.icon), $("#upload-app-name").text(a.appName), u.start()
                                }).catch(e => {
                                    alert(e, function () {
                                        try {
                                            u.splice(0, 1)
