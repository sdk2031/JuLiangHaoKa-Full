...
main()
`},we=(t,e)=>{ke.value=t,Re.value=e,de.value=!0},gt=t=>{xe.value=ct(t),we("push","推送示例")},_t=t=>{const e=t,s=qe(t.export_column_map);O.sourceCol=String(s.id_card_photos||"证件照片").trim(),O.targetCol=String(e.photo_target_col||"")||je(O.sourceCol),O.orderCol=String(s.order_no||"订单号").trim(),O.script=mt(t),we("photo","照片转图片示例")},ft=t=>w(null,null,function*(){ve.value=!0,we("callback","回调示例");try{const s=(yield Cl(t.id)).data||{},d=s.field_map||{},u=s.status_cols||{},f=(M,E)=>String(d[M]||E).trim(),C=(M,E)=>String(u[M]||E).trim();I.fieldRows=[{label:"订单号",value:f("order_no",t.sync_order_no_col||"订单号")},{label:"生产号码",value:f("production_number",t.sync_production_number_col||"生产号码")},{label:"ICCID",value:f("iccid",t.sync_iccid_col||"ICCID")},{label:"PUK",value:f("puk",t.sync_puk_col||"PUK")},{label:"快递公司",value:f("express_company",t.sync_express_company_col||"快递公司")},{label:"快递单号",value:f("tracking_number",t.sync_tracking_number_col||"快递单号")},{label:"备注",value:f("remark",t.sync_remark_col||"备注")},{label:"订单状态",value:f("order_status",t.sync_order_status_col||"订单状态")}],I.statusRows=[{label:"回传状态",value:C("status","回传状态")},{label:"回传时间",value:C("time","回传时间")},{label:"回传结果",value:C("result","回传结果")},{label:"回传签名",value:C("signature","回传签名")},{label:"已回传签名",value:C("synced_signature","已回传签名")},{label:"失败签名",value:C("failed_signature","失败签名")}],I.triggerBody=String(s.trigger_body||"").trim(),I.pyScript=String(s.script||"").trim(),I.triggerBody||(I.triggerBody=JSON.stringify({action:"callback_sync",config_id:t.id||0,trigger_source:"system_timer",trigger_time:new Date().toISOString().slice(0,19).replace("T"," ")},null,2)),I.pyScript||(I.pyScript="# 回调脚本生成失败，请稍后重试")}finally{ve.value=!1}}),Ke=et({props:{loading:Boolean,rows:{type:Array,required:!0},type:{type:String,required:!0}},emits:["detail","retry"],setup(t,{emit:e}){return()=>N(Ze,{loading:t.loading,data:t.rows,border:!0,stripe:!0},{default:()=>[N(P,{prop:"order_no",label:"订单号",minWidth:170}),N(P,{prop:"channel_name",label:"渠道",minWidth:130}),t.type==="push"?N(P,{prop:"event_type",label:"事件",width:120},{default:({row:s})=>ze(String(s.event_type||""))}):null,t.type==="push"?N(P,{prop:"trigger_source",label:"来源",width:130},{default:({row:s})=>Me(String(s.trigger_source||""))}):null,N(P,{prop:"status",label:"状态",width:100,align:"center"},{default:({row:s})=>N(il,{type:s.status==="success"?"success":s.status==="pending"?"warning":"danger"},()=>Be(String(s.status||"")))}),N(P,{prop:"message",label:"结果",minWidth:240,showOverflowTooltip:!0}),N(P,{prop:"created_time",label:"时间",width:170}),N(P,{label:"操作",width:t.type==="push"?130:86,fixed:"right",align:"center"},{default:({row:s})=>N(le,null,()=>[t.type==="push"&&s.status==="failed"?N(g,{link:!0,type:"warning",onClick:()=>e("retry",s)},()=>"重试"):null,N(g,{link:!0,type:"primary",onClick:()=>e("detail",s)},()=>"详情")])})]})}}),yt=()=>w(null,null,function*(){var e,s;const t=yield gl();ae.value=((e=t.data)==null?void 0:e.webhook_url)||"",ee.value=((s=t.data)==null?void 0:s.token)||""}),bt=()=>w(null,null,function*(){var e,s;const t=yield fl();Ie.value=((e=t.data)==null?void 0:e.channels)||[],pe.value=((s=t.data)==null?void 0:s.products)||[]}),z=()=>w(null,null,function*(){H.value=!0;try{const t=yield yl({page:j.page,limit:j.limit});Ne.value=t.data||[],j.total=Number(t.count||0)}finally{H.value=!1}}),vt=()=>w(null,null,function*(){re.value=!0;try{yield _l(ee.value),S.success("保存成功")}finally{re.value=!1}}),ie=t=>w(null,null,function*(){if(!t){S.warning("内容为空");return}yield navigator.clipboard.writeText(t||""),S.success("已复制")}),kt=()=>{Object.assign(i,Q(Q({id:0,export_mode:"channel_product",channel_key:"",product_ids:[],table_name:"",sheet_name:"",push_webhook_url:"",callback_trigger_webhook_url:"",remark:"",export_fields:K.map(t=>t.key),export_col_map:$e()},Oe()),De()))},qe=t=>{try{return t?JSON.parse(t):{}}catch(e){return{}}},xt=t=>t.api_name==="自营"?`self:${t.self_channel_id||0}`:t.api_name?`api:${t.api_name}`:"",He=t=>w(null,null,function*(){if(kt(),t){const e=qe(t.export_column_map),s=t.export_fields?t.export_fields.split(",").filter(Boolean):K.map(d=>d.key);Object.assign(i,{id:t.id,export_mode:t.export_mode||"channel_product",channel_key:xt(t),product_ids:(t.product_ids||[]).map(d=>Number(d)).filter(Boolean),table_name:t.table_name||"",sheet_name:t.sheet_name||"",push_webhook_url:t.push_webhook_url||"",callback_trigger_webhook_url:t.callback_trigger_webhook_url||"",remark:t.remark||"",export_fields:s,export_col_map:K.reduce((d,u)=>{const f=String(e[u.key]||"");return d[u.key]=f||(s.includes(u.key)?u.label:""),d},{})}),ce.forEach(d=>{i[d.key]=String(t[d.key]||"")}),se.forEach(d=>{i[d.key]=String(t[d.key]||"")})}L.value=!0,Te(()=>{var e;return(e=ne.value)==null?void 0:e.clearValidate()})}),ht=()=>{i.product_ids=[]},Ct=()=>{if(i.export_mode==="all"){i.channel_key="",i.product_ids=[],Te(()=>{var t;return(t=ne.value)==null?void 0:t.clearValidate(["channel_key","product_ids"])});return}i.export_mode==="channel_only"&&(i.product_ids=[],Te(()=>{var t;return(t=ne.value)==null?void 0:t.clearValidate(["product_ids"])}))},wt=()=>Q(Q({id:i.id,export_mode:i.export_mode,channel_key:i.channel_key,product_ids:i.product_ids,product_id:i.product_ids[0]||0,table_name:i.table_name,sheet_name:i.sheet_name,push_webhook_url:i.push_webhook_url,callback_trigger_webhook_url:i.callback_trigger_webhook_url,remark:i.remark,export_fields:i.export_fields,export_col_map:JSON.stringify(i.export_fields.reduce((t,e)=>{const s=String(i.export_col_map[e]||"").trim();return s&&(t[e]=s),t},{}))},ce.reduce((t,e)=>(t[e.key]=i[e.key],t),{})),se.reduce((t,e)=>(t[e.key]=i[e.key],t),{})),St=()=>w(null,null,function*(){var e;if(yield(e=ne.value)==null?void 0:e.validate(),i.export_mode!=="all"&&!i.channel_key){S.warning("请选择渠道");return}if(i.export_mode==="channel_product"&&!i.product_ids.length){S.warning("请至少选择一个产品");return}if(!i.export_fields.length){S.warning("请至少选择一个推送字段");return}const t=K.find(s=>i.export_fields.includes(s.key)&&!String(i.export_col_map[s.key]||"").trim());if(t){S.warning(`请先填写${t.label}列标题`);return}oe.value=!0;try{yield bl(wt()),S.success("保存成功"),L.value=!1,yield z()}finally{oe.value=!1}}),Vt=t=>w(null,null,function*(){yield Pe.confirm(`确定立即推送配置 #${t.id} 的订单数据吗？`,"确认推送",{type:"warning"});const s=(yield xl(t.id)).data||{};S.success(`推送完成：总数 ${s.total||0}，成功 ${s.success_count||0}，失败 ${s.failed_count||0}`)}),Et=t=>w(null,null,function*(){yield Pe.confirm(`确定立即执行配置 #${t.id} 的回调同步吗？`,"确认回调",{type:"warning"});const e=yield hl(t.id);S.success(e.msg||"执行完成")}),Pt=t=>w(null,null,function*(){he.value=t,Z.value=!0,ye.value=!0,b.enabled=!1,b.interval=5,b.batchSize=50,b.lastTime="",b.lastResult="";try{const s=(yield wl(t.id)).data||{};b.enabled=Number(s.callback_cron_enabled||0)===1,b.interval=Math.max(1,Number(s.callback_cron_interval||5)),b.batchSize=Math.max(1,Number(s.callback_cron_batch_size||50)),b.lastTime=String(s.callback_cron_last_time||""),b.lastResult=String(s.callback_cron_last_result||"")}finally{ye.value=!1}}),Tt=()=>w(null,null,function*(){const t=he.value;if(t){if(b.enabled&&!t.callback_trigger_webhook_url){S.warning("请先在编辑配置里填写回调Webhook");return}be.value=!0;try{yield Sl({id:t.id,callback_cron_enabled:b.enabled?1:0,callback_cron_interval:b.interval,callback_cron_batch_size:b.batchSize}),S.success("回调设置已保存"),Z.value=!1,yield z()}finally{be.value=!1}}}),Rt=t=>w(null,null,function*(){yield vl(t.id),S.success("复制成功"),yield z()}),It=t=>w(null,null,function*(){yield Pe.confirm(`确定删除云导出配置 #${t.id} 吗？`,"确认删除",{type:"warning"}),yield kl(t.id),S.success("删除成功"),yield z()}),G=()=>w(null,null,function*(){Y.value=!0;try{const t={page:D.page,limit:D.limit,order_no:F.order_no||"",status:F.status||""};if(h.value==="push"){const e=yield Vl(t);Ue.value=e.data||[],D.total=Number(e.count||0)}else{const e=yield El(t);Ae.value=e.data||[],D.total=Number(e.count||0)}}finally{Y.value=!1}}),Se=()=>{D.page=1,G()},Nt=()=>{F.order_no="",F.status="",Se()},Ge=t=>{We.value=t,U.value=!0},Ut=t=>w(null,null,function*(){const e=yield Pl(t.id);Number(e.code)===1?S.success(e.msg||"重试成功"):S.error(e.msg||"重试失败"),yield G()}),At=t=>{t==="history"?G():z()};return dl(()=>w(null,null,function*(){yield Promise.all([yt(),bt(),z(),G()])})),(t,e)=>{const s=ul,d=Ht,u=qt,f=Kt,C=jt,M=Qt,E=Jt,v=Yt,$=el,me=Zt,Ve=Xt,Qe=tl,Wt=ll,Lt=rl,Ot=ol,ge=al,Dt=nl,$t=sl,ue=pl("ripple"),Ee=Gt;return c(),y("div",Tl,[o(Qe,{modelValue:l(V),"onUpdate:modelValue":e[11]||(e[11]=r=>B(V)?V.value=r:null),onTabChange:At},{default:a(()=>[o(E,{label:"导出配置",name:"config"},{default:a(()=>[o(C,{shadow:"never",class:"config-card"},{header:a(()=>[n("div",Rl,[e[35]||(e[35]=n("div",null,[n("span",null,"接收配置"),n("p",null,"表格回调地址和 Token，供云文档脚本回传订单状态。")],-1)),q((c(),A(l(g),{type:"primary",loading:l(re),onClick:vt},{icon:a(()=>[o(s,{icon:"ri:save-line"})]),default:a(()=>[e[34]||(e[34]=m(" 保存 Token ",-1))]),_:1},8,["loading"])),[[ue]])])]),default:a(()=>[o(f,{gutter:12},{default:a(()=>[o(u,{xs:24,lg:16},{default:a(()=>[o(d,{modelValue:l(ae),"onUpdate:modelValue":e[1]||(e[1]=r=>B(ae)?ae.value=r:null),readonly:""},{prepend:a(()=>[...e[36]||(e[36]=[m("Webhook",-1)])]),append:a(()=>[o(l(g),{onClick:e[0]||(e[0]=r=>ie(l(ae)))},{default:a(()=>[...e[37]||(e[37]=[m("复制",-1)])]),_:1})]),_:1},8,["modelValue"])]),_:1}),o(u,{xs:24,lg:8},{default:a(()=>[o(d,{modelValue:l(ee),"onUpdate:modelValue":e[2]||(e[2]=r=>B(ee)?ee.value=r:null),modelModifiers:{trim:!0},"show-password":"",placeholder:"回调 Token"},{prepend:a(()=>[...e[38]||(e[38]=[m("Token",-1)])]),append:a(()=>[o(l(g),{onClick:ut},{default:a(()=>[...e[39]||(e[39]=[m("随机",-1)])]),_:1})]),_:1},8,["modelValue"])]),_:1})]),_:1})]),_:1}),o(C,{shadow:"never"},{header:a(()=>[n("div",Il,[e[42]||(e[42]=n("div",null,[n("span",null,"任务配置"),n("p",null,"按渠道或渠道+产品建立云文档推送规则。")],-1)),o(l(le),{wrap:""},{default:a(()=>[q((c(),A(l(g),{type:"primary",onClick:e[3]||(e[3]=r=>He())},{icon:a(()=>[o(s,{icon:"ri:add-line"})]),default:a(()=>[e[40]||(e[40]=m(" 新增配置 ",-1))]),_:1})),[[ue]]),q((c(),A(l(g),{loading:l(H),onClick:z},{icon:a(()=>[o(s,{icon:"ri:refresh-line"})]),default:a(()=>[e[41]||(e[41]=m(" 刷新 ",-1))]),_:1},8,["loading"])),[[ue]])]),_:1})])]),default:a(()=>[q((c(),A(l(Ze),{data:l(Ne),"row-key":"id",border:"",stripe:""},{default:a(()=>[o(l(P),{prop:"id",label:"ID",width:"78"}),o(l(P),{prop:"export_mode_text",label:"方式",width:"110"}),o(l(P),{prop:"channel_name",label:"产品渠道","min-width":"150"}),o(l(P),{label:"产品","min-width":"240"},{default:a(({row:r})=>[n("div",Nl,[n("div",Ul,x(Ce(r)[0]||"-"),1),Ce(r).length>1?(c(),A(l(g),{key:0,link:"",type:"primary",onClick:k=>it(r)},{default:a(()=>[...e[43]||(e[43]=[m(" 查看 ",-1)])]),_:1},8,["onClick"])):_e("",!0)])]),_:1}),o(l(P),{prop:"remark",label:"备注","min-width":"160"},{default:a(({row:r})=>[m(x(r.remark||"-"),1)]),_:1}),o(l(P),{label:"推送/回调",width:"210",align:"center"},{default:a(({row:r})=>[o(l(le),{wrap:""},{default:a(()=>[o(l(g),{link:"",type:"warning",onClick:k=>Vt(r)},{default:a(()=>[...e[44]||(e[44]=[m("推送",-1)])]),_:1},8,["onClick"]),o(l(g),{link:"",type:"primary",onClick:k=>Et(r)},{default:a(()=>[...e[45]||(e[45]=[m("回调",-1)])]),_:1},8,["onClick"]),o(l(g),{link:"",type:"primary",onClick:k=>Pt(r)},{default:a(()=>[...e[46]||(e[46]=[m("回调设置",-1)])]),_:1},8,["onClick"])]),_:2},1024)]),_:1}),o(l(P),{label:"自动化脚本代码",width:"220",align:"center"},{default:a(({row:r})=>[o(l(le),{wrap:""},{default:a(()=>[o(l(g),{link:"",type:"danger",onClick:k=>gt(r)},{default:a(()=>[...e[47]||(e[47]=[m("推送示例",-1)])]),_:1},8,["onClick"]),o(l(g),{link:"",type:"primary",onClick:k=>ft(r)},{default:a(()=>[...e[48]||(e[48]=[m("回调示例",-1)])]),_:1},8,["onClick"]),o(l(g),{link:"",type:"primary",onClick:k=>_t(r)},{default:a(()=>[...e[49]||(e[49]=[m("照片转图片示例",-1)])]),_:1},8,["onClick"])]),_:2},1024)]),_:1}),o(l(P),{label:"操作",width:"210",fixed:"right",align:"center"},{default:a(({row:r})=>[o(l(g),{link:"",type:"primary",onClick:k=>He(r)},{default:a(()=>[...e[50]||(e[50]=[m("编辑",-1)])]),_:1},8,["onClick"]),o(l(g),{link:"",type:"primary",onClick:k=>Rt(r)},{default:a(()=>[...e[51]||(e[51]=[m("复制",-1)])]),_:1},8,["onClick"]),o(l(g),{link:"",type:"danger",onClick:k=>It(r)},{default:a(()=>[...e[52]||(e[52]=[m("删除",-1)])]),_:1},8,["onClick"])]),_:1})]),_:1},8,["data"])),[[Ee,l(H)]]),n("div",Al,[o(M,{"current-page":l(j).page,"onUpdate:currentPage":e[4]||(e[4]=r=>l(j).page=r),"page-size":l(j).limit,"onUpdate:pageSize":e[5]||(e[5]=r=>l(j).limit=r),total:l(j).total,"page-sizes":[20,50,100],layout:"total, sizes, prev, pager, next, jumper",onSizeChange:z,onCurrentChange:z},null,8,["current-page","page-size","total"])])]),_:1})]),_:1}),o(E,{label:"推送历史",name:"history"},{default:a(()=>[o(C,{shadow:"never"},{default:a(()=>[o(Ve,{model:l(F),"label-width":"76px",class:"search-form"},{default:a(()=>[o(f,{gutter:12},{default:a(()=>[o(u,{xs:24,lg:7},{default:a(()=>[o(v,{label:"订单号"},{default:a(()=>[o(d,{modelValue:l(F).order_no,"onUpdate:modelValue":e[6]||(e[6]=r=>l(F).order_no=r),modelModifiers:{trim:!0},clearable:"",placeholder:"订单号",onKeyup:cl(Se,["enter"])},null,8,["modelValue"])]),_:1})]),_:1}),o(u,{xs:24,lg:5},{default:a(()=>[o(v,{label:"状态"},{default:a(()=>[o(me,{modelValue:l(F).status,"onUpdate:modelValue":e[7]||(e[7]=r=>l(F).status=r),clearable:"",placeholder:"全部状态"},{default:a(()=>[o($,{label:"成功",value:"success"}),o($,{label:"失败",value:"failed"})]),_:1},8,["modelValue"])]),_:1})]),_:1}),o(u,{xs:24,lg:8},{default:a(()=>[o(v,{class:"search-actions"},{default:a(()=>[o(l(le),{wrap:""},{default:a(()=>[q((c(),A(l(g),{type:"primary",onClick:Se},{icon:a(()=>[o(s,{icon:"ri:search-line"})]),default:a(()=>[e[53]||(e[53]=m(" 查询 ",-1))]),_:1})),[[ue]]),q((c(),A(l(g),{onClick:Nt},{icon:a(()=>[o(s,{icon:"ri:refresh-line"})]),default:a(()=>[e[54]||(e[54]=m(" 重置 ",-1))]),_:1})),[[ue]])]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["model"]),o(Qe,{modelValue:l(h),"onUpdate:modelValue":e[8]||(e[8]=r=>B(h)?h.value=r:null),onTabChange:G},{default:a(()=>[o(E,{label:"推送历史",name:"push"},{default:a(()=>[o(l(Ke),{loading:l(Y),rows:l(Ue),type:"push",onDetail:Ge,onRetry:Ut},null,8,["loading","rows"])]),_:1}),o(E,{label:"表格回调历史",name:"callback"},{default:a(()=>[o(l(Ke),{loading:l(Y),rows:l(Ae),type:"callback",onDetail:Ge},null,8,["loading","rows"])]),_:1})]),_:1},8,["modelValue"]),n("div",Wl,[o(M,{"current-page":l(D).page,"onUpdate:currentPage":e[9]||(e[9]=r=>l(D).page=r),"page-size":l(D).limit,"onUpdate:pageSize":e[10]||(e[10]=r=>l(D).limit=r),total:l(D).total,"page-sizes":[20,50,100],layout:"total, sizes, prev, pager, next, jumper",onSizeChange:G,onCurrentChange:G},null,8,["current-page","page-size","total"])])]),_:1})]),_:1})]),_:1},8,["modelValue"]),o(Ot,{modelValue:l(L),"onUpdate:modelValue":e[21]||(e[21]=r=>B(L)?L.value=r:null),title:l(i).id?"编辑配置":"新增配置",size:"860px","destroy-on-close":""},{footer:a(()=>[o(l(g),{onClick:e[20]||(e[20]=r=>L.value=!1)},{default:a(()=>[...e[62]||(e[62]=[m("取消",-1)])]),_:1}),o(l(g),{type:"primary",loading:l(oe),onClick:St},{default:a(()=>[...e[63]||(e[63]=[m("保存",-1)])]),_:1},8,["loading"])]),default:a(()=>[o(Ve,{ref_key:"editFormRef",ref:ne,model:l(i),rules:lt,"label-width":"112px"},{default:a(()=>[o(Wt,{"content-position":"left"},{default:a(()=>[...e[55]||(e[55]=[m("基础配置",-1)])]),_:1}),o(f,{gutter:12},{default:a(()=>[o(u,{xs:24,lg:12},{default:a(()=>[o(v,{label:"导出方式",prop:"export_mode"},{default:a(()=>[o(Lt,{modelValue:l(i).export_mode,"onUpdate:modelValue":e[12]||(e[12]=r=>l(i).export_mode=r),options:[{label:"全部",value:"all"},{label:"渠道+产品",value:"channel_product"},{label:"渠道",value:"channel_only"}],onChange:Ct},null,8,["modelValue"])]),_:1})]),_:1}),l(i).export_mode!=="all"?(c(),A(u,{key:0,xs:24,lg:12},{default:a(()=>[o(v,{label:"渠道",prop:"channel_key"},{default:a(()=>[o(me,{modelValue:l(i).channel_key,"onUpdate:modelValue":e[13]||(e[13]=r=>l(i).channel_key=r),filterable:"",placeholder:"选择渠道",onChange:ht},{default:a(()=>[(c(!0),y(T,null,W(l(Ie),r=>(c(),A($,{key:r.key,label:r.name,value:r.key},null,8,["label","value"]))),128))]),_:1},8,["modelValue"])]),_:1})]),_:1})):_e("",!0),l(i).export_mode==="channel_product"?(c(),A(u,{key:1,xs:24},{default:a(()=>[o(v,{label:"产品",prop:"product_ids"},{default:a(()=>[o(me,{modelValue:l(i).product_ids,"onUpdate:modelValue":e[14]||(e[14]=r=>l(i).product_ids=r),multiple:"",filterable:"","collapse-tags":"","collapse-tags-tooltip":"",placeholder:"选择产品"},{default:a(()=>[(c(!0),y(T,null,W(l(rt),r=>(c(),A($,{key:r.id,label:r.name,value:r.id},null,8,["label","value"]))),128))]),_:1},8,["modelValue"])]),_:1})]),_:1})):_e("",!0),o(u,{xs:24,lg:12},{default:a(()=>[o(v,{label:"表格名称",prop:"table_name"},{default:a(()=>[o(d,{modelValue:l(i).table_name,"onUpdate:modelValue":e[15]||(e[15]=r=>l(i).table_name=r),modelModifiers:{trim:!0},placeholder:"多维表格名称"},null,8,["modelValue"])]),_:1})]),_:1}),o(u,{xs:24,lg:12},{default:a(()=>[o(v,{label:"Sheet名称",prop:"sheet_name"},{default:a(()=>[o(d,{modelValue:l(i).sheet_name,"onUpdate:modelValue":e[16]||(e[16]=r=>l(i).sheet_name=r),modelModifiers:{trim:!0},placeholder:"Sheet名称"},null,8,["modelValue"])]),_:1})]),_:1}),o(u,{xs:24},{default:a(()=>[o(v,{label:"备注"},{default:a(()=>[o(d,{modelValue:l(i).remark,"onUpdate:modelValue":e[17]||(e[17]=r=>l(i).remark=r),type:"textarea",rows:2,maxlength:"300","show-word-limit":""},null,8,["modelValue"])]),_:1})]),_:1})]),_:1}),n("section",Ll,[e[56]||(e[56]=n("div",{class:"config-section-title"},"推送数据到WPS",-1)),e[57]||(e[57]=n("div",{class:"config-tip danger-tip"},"输入框中的标题必须和 WPS 表格列标题一致；如 WPS 表格标题修改，这里和 WPS 自动化流程需要同步修改。",-1)),o(v,{label:"推送Webhook"},{default:a(()=>[o(d,{modelValue:l(i).push_webhook_url,"onUpdate:modelValue":e[18]||(e[18]=r=>l(i).push_webhook_url=r),modelModifiers:{trim:!0},placeholder:"WPS 自动化 webhook 触发地址"},null,8,["modelValue"])]),_:1}),o(f,{gutter:12,class:"field-grid"},{default:a(()=>[(c(),y(T,null,W(K,r=>o(u,{key:r.key,xs:24,lg:12},{default:a(()=>[o(v,{label:r.label},{default:a(()=>[o(d,{modelValue:l(i).export_col_map[r.key],"onUpdate:modelValue":k=>l(i).export_col_map[r.key]=k,modelModifiers:{trim:!0},placeholder:r.placeholder},{append:a(()=>[o(l(g),{type:Je(r.key)?"primary":"",onClick:k=>dt(r)},{default:a(()=>[m(x(Je(r.key)?"已启用":"启用"),1)]),_:2},1032,["type","onClick"])]),_:2},1032,["modelValue","onUpdate:modelValue","placeholder"])]),_:2},1032,["label"])]),_:2},1024)),64))]),_:1})]),n("section",Ol,[e[60]||(e[60]=n("div",{class:"config-section-title"},"接收WPS回调数据",-1)),e[61]||(e[61]=n("div",{class:"config-tip danger-tip"},"输入框中的标题必须和 WPS 表格列标题一致；如 WPS 表格标题修改，这里和 WPS 自动化流程需要同步修改。",-1)),o(v,{label:"回调Webhook"},{default:a(()=>[o(d,{modelValue:l(i).callback_trigger_webhook_url,"onUpdate:modelValue":e[19]||(e[19]=r=>l(i).callback_trigger_webhook_url=r),modelModifiers:{trim:!0},placeholder:"WPS 回调自动化 webhook 触发地址"},null,8,["modelValue"])]),_:1}),o(f,{gutter:12},{default:a(()=>[(c(),y(T,null,W(ce,r=>o(u,{key:r.key,xs:24,lg:12},{default:a(()=>[o(v,{label:r.label},{default:a(()=>[o(d,{modelValue:l(i)[r.key],"onUpdate:modelValue":k=>l(i)[r.key]=k,modelModifiers:{trim:!0},placeholder:r.placeholder},null,8,["modelValue","onUpdate:modelValue","placeholder"])]),_:2},1032,["label"])]),_:2},1024)),64))]),_:1}),l(i).sync_order_status_col?(c(),y(T,{key:0},[e[58]||(e[58]=n("div",{class:"status-map-title"},"订单状态映射",-1)),e[59]||(e[59]=n("div",{class:"config-tip status-map-tip"},"WPS 回调的订单状态值如果不是系统默认状态名称，可在这里填写映射值；多个值用逗号分隔。",-1)),n("table",Dl,[n("tbody",null,[(c(!0),y(T,null,W(l(tt),r=>(c(),y("tr",{key:r.map(k=>k.key).join("_")},[(c(!0),y(T,null,W(r,k=>(c(),y(T,{key:k.key},[n("th",null,x(k.label),1),n("td",null,[o(d,{modelValue:l(i)[k.key],"onUpdate:modelValue":Ft=>l(i)[k.key]=Ft,modelModifiers:{trim:!0},placeholder:"多个值用逗号分隔"},null,8,["modelValue","onUpdate:modelValue"])])],64))),128))]))),128))])])],64)):_e("",!0)])]),_:1},8,["model"])]),_:1},8,["modelValue","title"]),o(ge,{modelValue:l(U),"onUpdate:modelValue":e[22]||(e[22]=r=>B(U)?U.value=r:null),title:"日志详情",width:"920px"},{default:a(()=>[n("div",$l,[n("table",Fl,[n("tbody",null,[(c(!0),y(T,null,W(l(nt),r=>(c(),y("tr",{key:r.key},[n("th",null,x(r.label),1),n("td",null,x(r.value||"-"),1)]))),128))])]),(c(!0),y(T,null,W(l(st),r=>(c(),y("div",{key:r.key,class:"log-json-section"},[n("div",zl,x(r.label),1),n("pre",Ml,x(r.value||"-"),1)]))),128))])]),_:1},8,["modelValue"]),o(ge,{modelValue:l(J),"onUpdate:modelValue":e[23]||(e[23]=r=>B(J)?J.value=r:null),title:"全部产品",width:"560px"},{default:a(()=>[n("div",Bl,[(c(!0),y(T,null,W(l(Le),r=>(c(),y("div",{key:r,class:"all-product-item"},x(r),1))),128))])]),_:1},8,["modelValue"]),o(ge,{modelValue:l(Z),"onUpdate:modelValue":e[28]||(e[28]=r=>B(Z)?Z.value=r:null),title:"回调设置",width:"640px","destroy-on-close":""},{footer:a(()=>[o(l(g),{onClick:e[27]||(e[27]=r=>Z.value=!1)},{default:a(()=>[...e[66]||(e[66]=[m("取消",-1)])]),_:1}),o(l(g),{type:"primary",loading:l(be),onClick:Tt},{default:a(()=>[...e[67]||(e[67]=[m("保存",-1)])]),_:1},8,["loading"])]),default:a(()=>[q((c(),A(Ve,{model:l(b),"label-width":"112px",class:"callback-cron-form"},{default:a(()=>[o(v,{label:"启用任务"},{default:a(()=>[o(Dt,{modelValue:l(b).enabled,"onUpdate:modelValue":e[24]||(e[24]=r=>l(b).enabled=r),"active-text":"开启","inactive-text":"关闭"},null,8,["modelValue"]),e[64]||(e[64]=n("div",{class:"form-tip"},"开启后，系统统一定时任务会按频率触发 WPS 的补偿回传 Webhook。",-1))]),_:1}),o(v,{label:"执行频率"},{default:a(()=>[o(me,{modelValue:l(b).interval,"onUpdate:modelValue":e[25]||(e[25]=r=>l(b).interval=r),placeholder:"选择频率"},{default:a(()=>[o($,{label:"每1分钟",value:1}),o($,{label:"每5分钟",value:5}),o($,{label:"每10分钟",value:10}),o($,{label:"每15分钟",value:15}),o($,{label:"每30分钟",value:30}),o($,{label:"每1小时",value:60})]),_:1},8,["modelValue"])]),_:1}),o(v,{label:"每批数量"},{default:a(()=>[o($t,{modelValue:l(b).batchSize,"onUpdate:modelValue":e[26]||(e[26]=r=>l(b).batchSize=r),min:1,max:500,step:10,"controls-position":"right"},null,8,["modelValue"]),e[65]||(e[65]=n("div",{class:"form-tip"},"单次触发最多处理的记录数，建议 50 左右，数据量大时可适当调高。",-1))]),_:1}),o(v,{label:"回调Webhook"},{default:a(()=>{var r;return[o(d,{"model-value":((r=l(he))==null?void 0:r.callback_trigger_webhook_url)||"",readonly:"",placeholder:"请先在编辑配置里填写回调Webhook"},null,8,["model-value"])]}),_:1}),o(v,{label:"最后执行"},{default:a(()=>[n("div",Jl,x(l(b).lastTime||"从未执行"),1)]),_:1}),o(v,{label:"执行结果"},{default:a(()=>[o(d,{"model-value":l(b).lastResult||"暂无",type:"textarea",rows:3,readonly:""},null,8,["model-value"])]),_:1})]),_:1},8,["model"])),[[Ee,l(ye)]])]),_:1},8,["modelValue"]),o(ge,{modelValue:l(de),"onUpdate:modelValue":e[33]||(e[33]=r=>B(de)?de.value=r:null),title:l(Re),width:"860px",class:"cloudexport-example-dialog","destroy-on-close":""},{default:a(()=>[q((c(),y("div",jl,[l(ke)==="push"?(c(),y(T,{key:0},[e[72]||(e[72]=n("div",{class:"example-section"},[n("div",{class:"example-title"},"第1步：在 WPS 新建 webhook 触发"),n("div",{class:"example-desc"},"进入当前多维表自动化，新建一条自动化，触发器选择 webhook 触发。保存后，把 WPS 生成的回调地址填到系统的推送 Webhook 地址里。")],-1)),n("div",Kl,[e[69]||(e[69]=n("div",{class:"example-title"},"第2步：给 webhook 增加请求体，并创建分支",-1)),e[70]||(e[70]=n("div",{class:"example-desc"},"下面是系统推送到 WPS 的 JSON 示例。目标表和视图名称要与 WPS 里的实际名称一致。",-1)),e[71]||(e[71]=n("div",{class:"example-copy-label"},"推送请求体示例",-1)),n("pre",ql,x(l(xe)),1),o(l(le),{wrap:""},{default:a(()=>[o(l(g),{type:"primary",onClick:e[29]||(e[29]=r=>ie(l(xe)))},{default:a(()=>[...e[68]||(e[68]=[m("复制请求体示例",-1)])]),_:1})]),_:1})])],64)):l(ke)==="photo"?(c(),y("div",Hl,[e[82]||(e[82]=n("div",{class:"example-title"},"照片转图片示例",-1)),e[83]||(e[83]=n("div",{class:"example-desc"},"这段脚本只处理当前多维表，不会请求后台。建议单独配置成一条自动化任务，监听证件照片链接列的新增或修改。",-1)),n("table",Gl,[e[79]||(e[79]=n("tr",null,[n("th",{style:{width:"220px"}},"项目"),n("th",null,"说明")],-1)),n("tr",null,[e[73]||(e[73]=n("td",null,"链接源列",-1)),n("td",null,[n("code",null,x(l(O).sourceCol),1)])]),n("tr",null,[e[74]||(e[74]=n("td",null,"订单号列",-1)),n("td",null,[n("code",null,x(l(O).orderCol),1)])]),n("tr",null,[e[78]||(e[78]=n("td",null,"图片目标列",-1)),n("td",null,[e[75]||(e[75]=m("请先在多维表里新增一个 ",-1)),e[76]||(e[76]=n("code",null,"图片和附件",-1)),e[77]||(e[77]=m(" 字段，字段名填 ",-1)),n("code",null,x(l(O).targetCol),1)])]),e[80]||(e[80]=n("tr",null,[n("td",null,"执行方式"),n("td",null,[m("触发器选 "),n("code",null,"新增或者修改记录时"),m("，动作选 "),n("code",null,"执行AirScript脚本"),m("。如要只处理当前变动行，请给脚本动作增加参数 "),n("code",null,"order_no"),m("，值绑定当前行的订单号变量。")])],-1))]),e[84]||(e[84]=n("div",{class:"example-copy-label"},"AirScript",-1)),n("pre",Ql,x(l(O).script),1),o(l(g),{type:"primary",onClick:e[30]||(e[30]=r=>ie(l(O).script))},{default:a(()=>[...e[81]||(e[81]=[m("复制脚本",-1)])]),_:1})])):(c(),y(T,{key:2},[n("div",Xl,[e[87]||(e[87]=n("div",{class:"example-title"},"一、回传字段",-1)),e[88]||(e[88]=n("div",{class:"example-desc"},"当前配置会回传给系统的业务字段如下。补偿任务会把这些列逐条 POST 回系统，供后端按 config_id 解析。",-1)),n("table",Yl,[e[85]||(e[85]=n("tr",null,[n("th",null,"字段"),n("th",null,"列名")],-1)),(c(!0),y(T,null,W(l(I).fieldRows,r=>(c(),y("tr",{key:r.label},[n("td",null,x(r.label),1),n("td",null,[n("code",null,x(r.value),1)])]))),128))]),e[89]||(e[89]=n("div",{class:"example-copy-label"},"回传状态字段",-1)),n("table",Zl,[e[86]||(e[86]=n("tr",null,[n("th",null,"字段"),n("th",null,"列名")],-1)),(c(!0),y(T,null,W(l(I).statusRows,r=>(c(),y("tr",{key:r.label},[n("td",null,x(r.label),1),n("td",null,[n("code",null,x(r.value),1)])]))),128))])]),n("div",er,[e[91]||(e[91]=n("div",{class:"example-title"},"二、系统触发 WPS 的 Webhook 请求体",-1)),e[92]||(e[92]=n("div",{class:"example-copy-label"},"请求体示例",-1)),n("pre",tr,x(l(I).triggerBody),1),o(l(g),{onClick:e[31]||(e[31]=r=>ie(l(I).triggerBody))},{default:a(()=>[...e[90]||(e[90]=[m("复制触发请求体",-1)])]),_:1})]),n("div",lr,[e[94]||(e[94]=n("div",{class:"example-title"},"三、Python 回调脚本",-1)),e[95]||(e[95]=n("div",{class:"example-copy-label"},"脚本",-1)),n("pre",rr,x(l(I).pyScript),1),o(l(g),{type:"primary",onClick:e[32]||(e[32]=r=>ie(l(I).pyScript))},{default:a(()=>[...e[93]||(e[93]=[m("复制 Python 脚本",-1)])]),_:1})])],64))])),[[Ee,l(ve)]])]),_:1},8,["modelValue","title"])])}}}),fr=ml(or,[["__scopeId","data-v-d82a55b7"]]);export{fr as default};
